    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('articles', models.ManyToManyField(through='articles.Scope', to='articles.article', verbose_name='Статьи')),
            ],
        ),
        migrations.AddField(
            model_name='scope',
        ...
        migrations.AddField(
            model_name='article',
            name='tags',
            field=models.ManyToManyField(blank=True, through='articles.Scope', to='articles.tag', verbose_name='Теги'),
        ),
    ]
